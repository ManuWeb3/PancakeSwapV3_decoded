/*
Integration of Different Routers:

The SmartRouter contract integrates the functionality of various swap routers, including V2SwapRouter, V3SwapRouter, and StableSwapRouter. This integration allows users to interact with different types of liquidity pools, 
// such as PancakeSwap V2, PancakeSwap V3, and Stable Swap pools, 
// all through a SINGLE CONTRACT INTERFACE i.e. [SmartRouter.sol]
*/
...
abstract contract V2SwapRouter is IV2SwapRouter, ImmutableState, PeripheryPaymentsWithFeeExtended, ReentrancyGuard {
    ...
    // supports fee-on-transfer tokens (SFOTT)
